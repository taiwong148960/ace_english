...
import type { PracticeTask } from "~/services/types"
...
/**
 * Pulse animation for the first task indicator
 */
...
/**
 * Individual task item component with animations
 */
function TaskItem({ task, isFirst, index, onToggle, onStartPractice }: TaskItemProps) {
  ...
  // First task gets special highlighted treatment
  if (isFirst) {
    return (
      <motion.div
      ...
      >
        ...
        >
          ...
          {/* Task icon with animated accent background */}
          <motion.div 
  ...
  return (
    ...
    >
      ...
      {/* Task icon with accent background */}
      <motion.div 
 ...
 * First task is highlighted with a Start Practice button
 */
