...
import type { TakeawayStats, BrowsingHistoryItem } from "~/services/types"
...
/**
 * Simple stat card - horizontal layout without background
 */
...
/**
 * Get icon and color for history item type (articles and videos only)
 */
...
/**
 * Single history item row - refined design
 */
function HistoryItem({ item, index }: HistoryItemProps) {
  ...
  return (
    <motion.a
      ...
      whileHover={{ x: 4 }}
    >
      {/* Type icon with refined styling */}
      <div className={cn(
      ...
      {/* Title - truncated with better typography */}
 ...
 * Shows stats at top and history list below
 */
