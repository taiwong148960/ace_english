...
import type { SkillScore, SkillsBreakdown } from "~/services/types"
 ...
 * Each skill has a distinct but muted color for visual harmony:
 * - Listening: Blue (calm, receiving)
 * - Reading: Green (text, growth)
 * - Writing: Purple (creativity, logic)
 * - Speaking: Amber (communication, warmth)
 */
function getSkillColor(skill: SkillScore["skill"]): string {
  const colorMap: Record<SkillScore["skill"], string> = {
    listening: "#5B8FD9", // Muted blue
    reading: "#4CAF85",   // Muted green
    writing: "#9575CD",   // Muted purple
    speaking: "#D4A054"   // Muted amber
  }
...
/**
 * Individual skill progress item with animation - compact single-line
 */
 ...
 * Displays listening, reading, writing, and speaking scores
 */
